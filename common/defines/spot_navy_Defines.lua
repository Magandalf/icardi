...
NDefines.NNavy.CARRIER_STACK_PENALTY_EFFECT = 0.05 -- Each carrier above the optimal amount decreases the amount of airplanes being able to takeoff by such %.
...
NDefines.NNavy.COMBAT_DAMAGE_TO_ORG_FACTOR = 0.65	--- casting damage value to ship organisation multiplier. Use it to balance the game difficulty.
...
NDefines.NNavy.COMBAT_DETECTED_CONVOYS_FROM_SURFACE_DETECTION_STAT = 0.07 --0.1 vanilla
...
NDefines.NNavy.NAVAL_INVASION_PREPARE_HOURS = 84
